        ...
        <div className="min-h-screen bg-black">
            ...
            <div className="bg-gradient-to-tl from-black via-black to-red-950 mx-auto min-h-screen justify-center lg:pb-24">
                ...
                <div className="justify-center flex flex-col items-center">
                    ...
                    <p className="text-white animate-slideInLeft text-xl text-pretty">Data z roku 2024: 650</p>
                    <p className="text-white animate-slideInLeft text-xl text-pretty p-5 max-w-6xl text-center">Zde je mírný nárůst, přesto se zde ale neusazuje tolik Čechů, jako například v jiných městech, zejména Mnichov a Berlín. Na svou lokaci ale není zas tak úplně liduprázdný co se Čechů týče, počty jsou zde vyšší než například na celém území Braniborska. Hamburg sleduje prudší nárůst od roku 2021.</p>
                </div>
            </div>
