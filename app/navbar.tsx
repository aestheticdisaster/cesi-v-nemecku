...
export default function Navbar() {
    return (
        <div className="pl-2 py-5 w-full bg-gradient-to-l from-black to-red-900">
            ...
            <Link href="/interaktivni-mapa" className="ml-8 text-xl text-white font-bold hover:text-black transition-all duration-300 hover:bg-red-600 p-3 rounded-md">Interaktivní mapa</Link>
        </div>
    );
}